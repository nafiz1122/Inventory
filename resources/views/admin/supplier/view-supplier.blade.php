              ...
              <div class="card-header">
                ...
                @endif
                  ...
                  <div style="float: right" class="pull-right">
                     <a class="btn btn-primary btn-sm" data-toggle="modal" data-target="#exampleModal" > <i class="fa fa-plus" ></i> Add Supplier</a>
                  </div>
              </div>
              <div class="card-body">
                    ...
                    <tbody>
                        @foreach ($suppliers as $key => $supplier)
                            <tr>
                                ...
                                <td width="15%" >
                                    <a class="btn btn-outline-info btn-sm" href=" {{route('supplier.edit',$supplier->id)}} "> <i class="fa fa-edit" ></i> </a>
                                    <a id="delete" class="btn btn-outline-danger btn-sm" href="{{route('supplier.delete',$supplier->id)}}"> <i class="fa fa-trash" ></i> </a>
                                </td>
                            </tr>
                        @endforeach
