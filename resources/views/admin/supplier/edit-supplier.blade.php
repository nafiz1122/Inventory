              ...
              <div class="card-header">
                ...
                @endif
                  ...
                  <div style="float: right" class="pull-right">
                     <a href=" {{route('supplier.list')}} " class="btn btn-primary btn-sm"> <i class="fa fa-list" ></i> Supplier List</a>
                  </div>
              </div>
              <div class="card-body">
                <form id="quickForm" action="{{route('supplier.update',$supplier->id)}}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input id="input" type="text" name="name" class="form-control" value=" {{$supplier->name}} ">
                        <font id="error">{{($errors->has('name'))?($errors->first('name')):''}}</font>
                    </div>
                    <div class="form-group">
                        <label for="">Mobile No</label>
                        <input id="input" type="text" name="phone_no" class="form-control" value=" {{$supplier->phone_no}} ">
