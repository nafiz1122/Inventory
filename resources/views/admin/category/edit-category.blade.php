              ...
              <div class="card-header">
                ...
                @endif
                  ...
                  <div style="float: right" class="pull-right">
                     <a href=" {{route('category.list')}} " class="btn btn-primary btn-sm"> <i class="fa fa-list" ></i> Category List</a>
                  </div>
              </div>
              <div class="card-body">
                <form id="quickForm" action="{{route('category.update',$category->id)}}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input id="input" type="text" name="name" class="form-control" value=" {{$category->name}} ">
