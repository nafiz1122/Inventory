          ...
          <div class="card">
              <div class="card-header">
                  <div style="float: right" class="pull-right">
                     <a class="btn btn-primary btn-sm" data-toggle="modal" data-target="#exampleModal" > <i class="fa fa-plus" ></i> Add User</a>
                  </div>
              </div>
              <div class="card-body">
                    ...
                    <tbody>
                        @foreach ($users as $key => $user)
                            <tr>
                                ...
                                <td width="15%" >
                                    <a class="btn btn-outline-info btn-sm" href=" {{route('user.edit',$user->id)}} "> <i class="fa fa-edit" ></i> </a>

                                    <a class="btn btn-outline-danger btn-sm" href="{{route('user.delete',$user->id)}}"> <i class="fa fa-trash" ></i> </a>
                                </td>
                            </tr>
                        @endforeach
